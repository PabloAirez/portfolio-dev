...
const AboutMe: React.FC = () => {
    ...
    return (
        <section id="sobre" className={`py-12 transition-all duration-1000 bg-black/80 ${show ? 'animate-slide-in' : 'animate-slide-out'}`}>
            <div className="flex lg:flex-row flex-col gap-3 justify-center container mx-auto px-5 py-5 bg-black/60 rounded-lg border-2 border-purple-500">
