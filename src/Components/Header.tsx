...
const Header = () => {
    return (
        <header className='w-full h-96 bg-red-500 bg-center bg-cover bg-[url("/src/assets/img/background.gif")]'>  
            <div className='flex flex-col items-center gap-6 justify-center h-full'>
                ...
                <div className='flex gap-4'>
                    <button className='bg-purple-500 text-white font-bold py-2 px-4 rounded hover:bg-purple-700 duration-300 animate-fade-in'>Download CV</button>
